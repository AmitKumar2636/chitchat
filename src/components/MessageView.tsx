...
import { messages, loadingMessages, currentChatId, currentChat, otherUserPresence } from '../stores/chats';
      ...
      >
        ...
        <header class="flex items-center gap-4 px-4 py-3 bg-wa-header dark:bg-wa-dark-header border-b border-wa-border dark:border-wa-dark-border min-h-[60px]">
          ...
          <div class="flex flex-col">
            ...
            <span class="text-sm">
              <Show when={otherUserInfo().isTyping} fallback={
                <span class={otherUserInfo().isOnline 
                  ? 'text-wa-light-green' 
        ...
        >
          ...
          >
            ...
            <TextField.Input
              ...
              autocomplete="off"
              class="w-full px-4 py-3 rounded-lg border-none bg-white dark:bg-wa-dark-sidebar text-wa-text-primary dark:text-wa-dark-text-primary placeholder:text-wa-text-muted focus:outline-none focus:ring-2 focus:ring-wa-teal"
            />
          </TextField>
          <Button 
            type="submit" 
            ...
            class="w-12 h-12 rounded-full bg-wa-teal text-white flex items-center justify-center hover:bg-wa-dark-green disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors focus:outline-none focus:ring-2 focus:ring-wa-teal focus:ring-offset-2"
          >
